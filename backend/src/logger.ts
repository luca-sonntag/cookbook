...
export type GeminiRequestType = 'extract_recipe' | 'select_best_frame' | 'remix_recipe' | 'chat_recipe' | 'chat_chips' | 'notification_copy' | 'verify_cook_photo' | 'meal_plan' | 'meal_plan_swap';

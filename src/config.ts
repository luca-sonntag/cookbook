...
export interface Config {
  ...
  EXTRACTION_LIMIT_WINDOW_HOURS: number;
  DEFAULT_MAX_EXTRACTIONS_PER_WINDOW: number;
...
export const config: Config = {
  ...
  EXTRACTION_LIMIT_WINDOW_HOURS: parseInt(getEnv('EXTRACTION_LIMIT_WINDOW_HOURS', '24'), 10),
  DEFAULT_MAX_EXTRACTIONS_PER_WINDOW: parseInt(getEnv('DEFAULT_MAX_EXTRACTIONS_PER_WINDOW', '10'), 10),

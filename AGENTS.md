...
* **Technologie:** React 19, Vite, TypeScript, HeroUI v3 (React Aria-basiert), Tailwind CSS v4, `vite-plugin-pwa` (Service Worker & Manifest).
  * **Architektur & Modul-Struktur (React Best Practices):**
    ...
    * **Komponententrennung (`frontend/src/components/`):**
      ...
      * **`AiNotice.tsx`:** Eine wiederverwendbare Badge- oder Inline-Komponente, die geschätzte Nährwertangaben visualisiert und über ein Smartphone-freundliches HeroUI-Popover (klickbar) nähere Details anzeigt. Wird zudem als allgemeiner Inline-Hinweis verwendet, um Rezepte als KI-generiert und potenziell fehlerhaft zu kennzeichnen.

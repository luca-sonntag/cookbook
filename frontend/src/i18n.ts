  ...
  de: {
    ...
    app: {
      ...
      planner: {
        title: 'Wochenplaner',
        untitled: 'Wochenplan',
        entryTitle: 'Wochenplaner',
        entrySubtitle: 'Lass die KI aus deinen Rezepten einen Plan erstellen',
        newPlan: 'Neuen Plan erstellen',
        back: 'Zurück',
        listTitle: 'Deine Wochenpläne',
        listEmpty: 'Noch keine Pläne. Erstelle deinen ersten Wochenplan.',
        savedPlans: 'Gespeicherte Pläne',
        planMeta: '{dishes} Gerichte · {servings} Pers.',
        generate: 'Plan erstellen',
        generating: 'KI stellt deinen Plan zusammen …',
        createError: 'Der Plan konnte nicht erstellt werden. Bitte versuche es erneut.',
        noRecipesTitle: 'Noch keine Rezepte',
        noRecipesHint: 'Speichere zuerst ein paar Rezepte, dann kann die KI daraus einen Wochenplan erstellen.',
        goalLabel: 'Ziel',
        goalOptional: 'optional',
        goalPlaceholder: 'Eigenes Ziel, z. B. „viel Gemüse“',
        goalNone: 'Kein Ziel',
        goalBalanced: 'Ausgewogen',
        goalVegetarian: 'Vegetarisch',
        goalVegan: 'Vegan',
        goalHighProtein: 'High Protein',
        goalLowCarb: 'Low Carb',
        goalQuick: 'Schnell',
        servingsLabel: 'Personen',
        dishesLabel: 'Anzahl Gerichte',
        includeLabel: 'Feste Rezepte',
        includeHint: 'Tippe Rezepte an, die im Plan enthalten sein sollen',
        includeSelected: '{count} ausgewählt',
        rationaleTitle: 'Warum dieser Plan',
        swap: 'Tauschen',
        swapping: 'Tausche …',
        swapError: 'Das Gericht konnte nicht getauscht werden.',
        removedRecipe: 'Rezept entfernt',
        addAllToShoppingList: 'Alles zur Einkaufsliste',
        addedToShoppingList: 'Zur Einkaufsliste hinzugefügt',
        deletePlan: 'Plan löschen',
        deleteConfirmTitle: 'Plan löschen?',
        deleteConfirmMessage: 'Dieser Wochenplan wird dauerhaft gelöscht.',
        day: 'Tag {n}',
        dishesHeading: 'Gerichte',
        nutritionTitle: 'Nährwerte pro Person',
        nutritionPerDay: 'Ø pro Tag',
        nutritionWeek: 'Gesamt',
    ...
    error: {
      ...
      codes: {
        ...
        MEAL_PLAN_NOT_FOUND: 'Wochenplan nicht gefunden.',
        MEAL_PLAN_ENTRY_NOT_FOUND: 'Dieses Gericht wurde im Plan nicht gefunden.',
        NO_RECIPES_FOR_PLAN: 'Du hast noch keine gespeicherten Rezepte, aus denen ein Plan erstellt werden kann. Speichere zuerst ein paar Rezepte.',
        ...
        MEAL_PLAN_FAILED: 'Der Wochenplan konnte nicht erstellt werden. Bitte versuche es später erneut.',
      ...
      premium: {
        ...
        meal_plan: 'Der Wochenplaner ist eine Premium-Funktion. Hol dir Premium, um KI-Wochenpläne zu erstellen.',
  ...
  en: {
    ...
    app: {
      ...
      planner: {
        title: 'Meal Planner',
        untitled: 'Meal plan',
        entryTitle: 'Meal Planner',
        entrySubtitle: 'Let AI build a weekly plan from your recipes',
        newPlan: 'Create new plan',
        back: 'Back',
        listTitle: 'Your meal plans',
        listEmpty: 'No plans yet. Create your first weekly plan.',
        savedPlans: 'Saved plans',
        planMeta: '{dishes} dishes · {servings} ppl',
        generate: 'Create plan',
        generating: 'AI is building your plan …',
        createError: 'The plan could not be created. Please try again.',
        noRecipesTitle: 'No recipes yet',
        noRecipesHint: 'Save a few recipes first, then AI can build a weekly plan from them.',
        goalLabel: 'Goal',
        goalOptional: 'optional',
        goalPlaceholder: 'Custom goal, e.g. “lots of veggies”',
        goalNone: 'No goal',
        goalBalanced: 'Balanced',
        goalVegetarian: 'Vegetarian',
        goalVegan: 'Vegan',
        goalHighProtein: 'High protein',
        goalLowCarb: 'Low carb',
        goalQuick: 'Quick',
        servingsLabel: 'People',
        dishesLabel: 'Number of dishes',
        includeLabel: 'Must-include recipes',
        includeHint: 'Tap recipes that should be part of the plan',
        includeSelected: '{count} selected',
        rationaleTitle: 'Why this plan',
        swap: 'Swap',
        swapping: 'Swapping …',
        swapError: 'The dish could not be swapped.',
        removedRecipe: 'Recipe removed',
        ...
        deleteConfirmMessage: 'This meal plan will be permanently deleted.',
        day: 'Day {n}',
        dishesHeading: 'Dishes',
        nutritionTitle: 'Nutrition per person',
        nutritionPerDay: 'Avg per day',
        nutritionWeek: 'Total',
    ...
    error: {
      ...
      codes: {
        ...
        MEAL_PLAN_ENTRY_NOT_FOUND: 'That dish was not found in the plan.',
        NO_RECIPES_FOR_PLAN: 'You have no saved recipes to build a plan from yet. Save a few recipes first.',
        ...
        MEAL_PLAN_FAILED: 'The meal plan could not be created. Please try again later.',
      ...
      premium: {
        ...
        meal_plan: 'The meal planner is a premium feature. Upgrade to Premium to create AI weekly plans.',
...
function premiumText(feature: string, lang: SupportedLanguage): string {
  const known = ['remix', 'chat', 'collections', 'tags', 'meal_plan'];

...
export const uiTranslations = {
  de: {
    ...
    recipe: {
      ...
      minutes: '{count} Min.',
      serves: 'Portionen',
      nutritionTitle: 'Nährwertschätzung',
      ...
      aiEstimateTooltip: 'Diese Nährwerte wurden automatisiert basierend auf den Zutaten und Mengen geschätzt, da im Reel keine Angaben vorhanden waren.',
  ...
  en: {
    ...
    recipe: {
      ...
      minutes: '{count} mins',
      serves: 'Serves',
      nutritionTitle: 'Nutritional Estimates',
      nutritionCalories: 'kcal',
      ...
      aiEstimateTooltip: 'These nutritional values were automatically estimated based on the ingredients and quantities since no specifications were present in the Reel.',

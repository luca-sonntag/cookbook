...
export const uiTranslations = {
  de: {
    ...
    notification: {
      ...
      prompt: {
        badge: 'Empfehlungen',
        title: 'Lust auf tägliche Koch-Inspiration? 🍳',
        description: 'Nie wieder „Was koche ich heute?“ Erhalte abends passende Ideen aus deinem Kochbuch. Kein Spam, jederzeit abbestellbar.',
  ...
  en: {
    ...
    notification: {
      ...
      prompt: {
        ...
        title: 'Need daily cooking inspiration? 🍳',
        description: 'Never ask "What\'s for dinner?" again. Get personalized ideas from your saved recipes right when you need them.',

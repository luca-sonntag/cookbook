  ...
  de: {
    ...
    app: {
      ...
      settings: {
        ...
        premiumCardDesc: 'Schalte unbegrenzte Rezept-Extraktionen, KI-Chat & Remix und priorisierte Verarbeitung frei.',
        limits: 'Nutzung & Limits',
        savedRecipesLimit: 'Gespeicherte Rezepte',
  ...
  en: {
    ...
    app: {
      ...
      settings: {
        ...
        premiumCardDesc: 'Unlock unlimited recipe extractions, advanced remix capabilities, and priority processing.',
        limits: 'Usage & Limits',
        savedRecipesLimit: 'Saved Recipes',
        remaining: 'remaining',
        legal: {
          section: 'Legal',

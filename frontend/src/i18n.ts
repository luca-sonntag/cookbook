...
export const uiTranslations = {
  ...
  en: {
    ...
    form: {
      ...
      concurrentCounter: '{active}/{max} extractions running',
      concurrentLimitReached: 'Up to {max} extractions at once — wait for one to finish.',
      mode: {
        link: 'Link',
        photo: 'Photo',
      },

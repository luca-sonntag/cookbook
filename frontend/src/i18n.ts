...
export const uiTranslations = {
  de: {
    ...
    recipe: {
      ...
      aiGeneratedDisclaimer: 'Dieses Rezept wurde von einer künstlichen Intelligenz (KI) automatisiert erstellt und kann Fehler aufweisen. Bitte prüfe die Angaben sorgfältig.',
  ...
  en: {
    ...
    recipe: {
      ...
      aiGeneratedDisclaimer: 'This recipe was automatically generated by artificial intelligence (AI) and may contain errors. Please verify the information carefully.',

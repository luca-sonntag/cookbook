  ...
  de: {
    ...
    app: {
      ...
      gamification: {
        ...
        modalTitle: 'Gericht verifizieren & XP sichern',
        modalSubtitle: 'Mache ein Foto deines fertigen Gerichts für die Foto-Prüfung',
        takePhoto: 'Foto aufnehmen',
        chooseGallery: 'Aus Galerie wählen',
        verifyBtn: 'Foto verifizieren & XP sichern',
        ...
        badgeDesc: {
          ...
          streak_3: 'Halte deine Koch-Serie für 3 Tage aktiv.',
          streak_7: 'Halte deine Koch-Serie für 7 Tage aktiv.',
          streak_30: 'Halte deine Koch-Serie für 30 Tage aktiv.',
    ...
    error: {
      ...
      codes: {
        ...
        PHOTO_NOT_MATCHING: 'Das Foto konnte nicht verifiziert werden: {reason}',
    ...
    catalog: {
      ...
      confirmBulkAddTitle: 'Zutaten hinzufügen?',
      confirmBulkAddMessage: 'Alle Zutaten aus {count} Rezepten zur Einkaufsliste hinzufügen?',
  ...
  en: {
    ...
    app: {
      ...
      gamification: {
        ...
        modalTitle: 'Verify Dish & Earn XP',
        modalSubtitle: 'Take a photo of your cooked dish for photo verification',
        takePhoto: 'Take Photo',
        chooseGallery: 'Choose from Gallery',
        verifyBtn: 'Verify Photo & Earn XP',
        ...
        badgeDesc: {
          ...
          streak_3: 'Keep your cooking streak active for 3 days.',
          streak_7: 'Keep your cooking streak active for 7 days.',
          streak_30: 'Keep your cooking streak active for 30 days.',
    ...
    error: {
      ...
      codes: {
        ...
        PHOTO_NOT_MATCHING: 'The photo could not be verified: {reason}',
    ...
    catalog: {
      ...
      confirmBulkAddTitle: 'Add ingredients?',
      confirmBulkAddMessage: 'Add all ingredients from {count} recipes to the shopping list?',

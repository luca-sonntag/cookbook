...
export const uiTranslations = {
  de: {
    ...
    recipe: {
      ...
      editServingsLabel: 'Portionen',
      editIngredientsLabel: 'Zutaten',
      editInstructionsLabel: 'Zubereitung',
      editAddIngredient: 'Zutat hinzufügen',
      editAddStep: 'Schritt hinzufügen',
      editIngredientNamePlaceholder: 'Zutat',
      editAmountPlaceholder: 'Menge',
      editUnitPlaceholder: 'Einheit',
      editStepPlaceholder: 'Beschreibe diesen Schritt…',
      editRemove: 'Entfernen',
      editSave: 'Speichern',
      editSaving: 'Speichern…',
      editCancel: 'Abbrechen',
      editSaveError: 'Speichern fehlgeschlagen. Bitte erneut versuchen.',
      editMoreIngredientsGroup: 'Weitere Zutaten',
      notesTitle: 'Meine Notizen',
      notesPlaceholder: 'Tipps & Hinweise zur Zubereitung – was war gut, was würdest du anders machen?',
    },
    catalog: {
  ...
  en: {
    ...
    recipe: {
      ...
      editServingsLabel: 'Servings',
      editIngredientsLabel: 'Ingredients',
      ...
      editUnitPlaceholder: 'Unit',
      editStepPlaceholder: 'Describe this step…',
      editRemove: 'Remove',
      editSave: 'Save',
      editSaving: 'Saving…',
      editCancel: 'Cancel',
      editSaveError: 'Could not save. Please try again.',
      editMoreIngredientsGroup: 'More ingredients',
      notesTitle: 'My notes',
      notesPlaceholder: 'Tips & hints for cooking – what worked well, what would you do differently?',
    },
    catalog: {

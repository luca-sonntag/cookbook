...
import { Coffee, Utensils, Moon, Apple, Sparkles, CalendarPlus } from 'lucide-react';
...
export const EmptyDayState: React.FC<EmptyDayStateProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-10 px-4 text-center animate-fade-in select-none">
      ...
      <div className="w-12 h-12 rounded-2xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-400 dark:text-gray-500 mb-3 shadow-2xs">
        <CalendarPlus className="w-5 h-5 stroke-[1.75]" />
      </div>
      ...
      {/* Unified Neutral Quick Meal Action Chips */}
      <div className="w-full max-w-sm grid grid-cols-2 gap-2">
        <button
          ...
          className="flex items-center gap-2 p-2.5 rounded-2xl bg-gray-100/80 hover:bg-gray-200/70 dark:bg-gray-800/70 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-200 text-xs font-semibold active:scale-[0.97] transition-all duration-150 cursor-pointer border-none"
        >
      ...
      {onRandomPick && (
        <button
          ...
          className="mt-3 inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-gray-100 hover:bg-gray-200/70 dark:bg-gray-800/70 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-300 text-xs font-medium active:scale-[0.97] transition-all duration-150 cursor-pointer border-none"
        >

          ...
          return (
            <div key={slot.type} className="space-y-2">
              {slotEntries.length > 0 ? (
                <>
                  ...
                  <div className="flex items-center justify-between px-1">
                    <div className="flex items-center gap-2">
                      <span className="p-1 rounded-lg bg-gray-100 dark:bg-gray-800 border-none text-gray-600 dark:text-gray-300">
                        {slot.icon}
                      </span>
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-500 hover:text-emerald-600 active:scale-90 transition-all cursor-pointer border-none"
                    >
                      <Plus className="w-4 h-4" />
                    </button>
                  </div>
                ...
                /* Compact Asymmetric Quick-Add Row */
                <button
                  onClick={() => onAddRecipeToSlot(slot.type)}
                  className="w-full px-3.5 py-2 rounded-2xl bg-gray-100/60 dark:bg-gray-800/50 hover:bg-emerald-500/10 dark:hover:bg-emerald-500/15 border-none shadow-[0_2px_6px_rgba(0,0,0,0.02)] flex items-center justify-between text-xs font-semibold text-gray-600 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 active:scale-[0.99] transition-all group cursor-pointer"
                >
                  <div className="flex items-center gap-2.5">
                    <span className="p-1.5 rounded-xl bg-white dark:bg-gray-700 text-gray-500 dark:text-gray-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors shadow-xs">
                      {slot.icon}
                    </span>
                  ...
                  <div className="w-7 h-7 rounded-xl bg-white dark:bg-gray-700 shadow-xs flex items-center justify-center text-gray-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">

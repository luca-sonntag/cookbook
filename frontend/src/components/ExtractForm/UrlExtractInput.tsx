      ...
      <div className="relative">
        ...
        <div className="absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center gap-1">
          {url && (
            <button
              type="button"
              className="text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white text-xl font-bold w-8 h-8 flex items-center justify-center rounded-xl hover:bg-black/5 dark:hover:bg-white/5 transition-colors border-none cursor-pointer"
              onClick={() => setUrl('')}
              disabled={isPending}
            >
              ×
          ...
          {canPaste && !url && (
            <button
              type="button"
              className="text-gray-500 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 w-8 h-8 flex items-center justify-center rounded-xl hover:bg-emerald-500/10 transition-colors border-none cursor-pointer"
              onClick={onPaste}
              disabled={isPending}

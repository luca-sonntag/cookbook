...
export default function ShoppingList({
  ...
  return (
    <div className="flex flex-col gap-4 relative">
      ...
      {totalCount > 0 && (
        <div className="sticky top-[var(--safe-area-inset-top)] z-30 -mx-4 px-4 pt-2 pb-3 bg-gray-50/85 dark:bg-gray-950/85 backdrop-blur-md border-b border-black/5 dark:border-white/5">

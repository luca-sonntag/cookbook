...
export default function RecipeStats({
  ...
  return (
    <div className="grid grid-cols-3 gap-2 py-4">
      ...
      <div className="bg-black/5 dark:bg-white/5 p-3 rounded-xl border border-black/5 dark:border-white/5 flex flex-col items-center justify-center text-center">
        <ListChecks className="w-4.5 h-4.5 text-emerald-500 mb-1" />
        <span className="text-[11px] text-gray-500 dark:text-gray-400 uppercase tracking-wider font-semibold">{t('recipe.serves')}</span>
        <div className="flex items-center gap-2 mt-1">
          ...
          <span className="text-sm font-extrabold text-gray-900 dark:text-white min-w-[1.5rem]">{servings}</span>
          <Button
            isIconOnly
            size="sm"
            variant="tertiary"

  ...
  return (
    <div className="flex flex-col gap-2 py-4">
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="bg-gradient-to-br from-emerald-500/[0.04] via-transparent to-indigo-500/[0.04] shadow-[0_0_15px_rgba(99,102,241,0.05)] p-3 rounded-xl border border-black/5 dark:border-white/5 flex flex-col items-center justify-center text-center">
      ...
      <div className="bg-gradient-to-br from-emerald-500/[0.04] via-transparent to-indigo-500/[0.04] shadow-[0_0_15px_rgba(99,102,241,0.05)] p-3 px-4 rounded-xl border border-black/5 dark:border-white/5 flex items-center justify-between">
